...
def y_predict():
    ...
    with open('cv.pkl','rb') as file:
        ...
        output=prediction[0]
        if(output<0.5):
            return render_template('index.html',prediction_text="The tweet has Negative Emotions ")
        else:
            return render_template('index.html',prediction_text="The tweet has Positive Emotions",image=True)
